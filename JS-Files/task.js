...
addIcon.addEventListener("click", () => {
  ...
  if (
    formAdd.classList.contains("add") &&
    addIcon.classList.contains("rotat")
  ) {
...
function getTaskFromLocal() {
  ...
  if (arrOfObjct != null) {
    ...
    document.querySelector(
      ".all-task"
    ).innerHTML = `<h3>There are no tasks to display. <span id ="noTasks">Let's put the first one up.</span></h3>`;
  }
}
